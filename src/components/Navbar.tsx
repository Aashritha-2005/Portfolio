...
export default function Navbar() {
  ...
  return (
    <FadeIn y={-20} delay={0}>
            <nav className="fixed top-3 left-1/2 -translate-x-1/2 z-50 flex items-center justify-between px-6 md:px-10 pt-2 pb-[17px] bg-[#0C0C0C]/80 backdrop-blur-md border border-white/10 rounded-2xl w-[90%] max-w-5xl">
