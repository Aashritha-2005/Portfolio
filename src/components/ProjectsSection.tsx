...
const projects: Project[] = [
  ...
  },
  {
    ...
    contributions: [
      '4-signal trust-scoring model — combines graph path length, semantic similarity, recency decay, and contradiction penalty to rank agent memory reliability',
      'Detects contradicted decisions at 0.28 confidence vs. 0.99 for the correct superseding decision, despite equal semantic similarity',
      'Injects HIGH/MEDIUM/LOW labeled context into live coding-agent sessions via a custom bridge hook',
      'Shipped to production on Railway with CI-gated deploys — 28-test suite, ruff linting, 100% pass rate',
    ],
