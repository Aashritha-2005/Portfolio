...
export default function Navbar() {
  ...
  return (
    <FadeIn y={-20} delay={0}>
      <nav className="fixed top-0 left-0 right-0 z-50 grid grid-cols-3 items-center px-6 md:px-12 pt-2 pb-[17px] bg-[#0C0C0C]/80 backdrop-blur-md border-b border-white/5">
